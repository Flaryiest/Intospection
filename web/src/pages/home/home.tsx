            ...
            <div className={styles.content}>
                ...
                <div className={styles.sectionTwo}>
                    ...
                    <div className={styles.sectionTwoText}>
                        <p>
                            In my free time, I enjoy writing and reading all
                            types of works.
                        </p>
                        <p>
                            Will hopefully be sharing most of my writing here in
                            the future, and would always love to get thoughts!
                        </p>
                    </div>
                </div>
                <div className={styles.sectionDivider}></div>
